...
The demo reads the repository's existing Real places library. No terrain data
is downloaded from an external service. The seven event captures use the labelled
process-study fixtures. Generated and Real places maps are also selectable and browser-tested.

Prototype code reuse: Carve engine and character at b14e23f are vendored in carve/ with
local lava-hardness lookups and a dry-preview correction. Craterize's working tree was
